...
while True:
    ...
    if counter == 10:
        ...
        paddle.y = 0
        paddle1.y = 0
        canvas.create_text(250, 200, text="Congrats Player 1! You Win!", font=("Arial", 32), fill="red")
        canvas.create_text(250, 215, text="Score: " + str(counter) + " - " + str(counter1), font=("Arial", 32), fill="red")
    if counter1 == 10:
        ball.x = 0
        ball.y = 0
        paddle.y = 0
        paddle1.y = 0
        canvas.create_text(250, 200, text="Congrats Player 2! You Win!", font=("Arial", 32), fill="red")
        canvas.create_text(250, 215, text="Score: " + str(counter) + " - " + str(counter1), font=("Arial", 32), fill="red")
